...
class User extends CI_Controller
{
    ...
    public function datakategori()
    {
        ...
        foreach ($list as $r) {
            ...
            $tomboledit = level_user('user', 'kategori', $this->session->userdata('kategori'), 'edit') > 0 ? '<li><a href="#" onclick="edit(this)" data-id="' . $this->security->xss_clean($r->id) . '">Ubah</a></li>' : '';
    ...
    public function datausers()
    {
        ...
        foreach ($query->result() as $r) {
            ...
            $tomboledit = level_user('user', 'user', $this->session->userdata('kategori'), 'edit') > 0 ? '<li><a href="#" onclick="edit(this)" data-id="' . $r->id . '">Ubah</a></li>' : '';
