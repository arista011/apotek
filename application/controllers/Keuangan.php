	...
	cekajax();
        ...
        foreach ($list as $r) { 
            ...
            if($r->editable == '1'){ 
                ...
                $tomboledit = level_user('keuangan','koderekening',$this->session->userdata('kategori'),'edit') > 0 ? '<li><a href="#" onclick="edit(this)" data-id="'.$r->kode_rekening.'">Ubah</a></li>':'';
				$row[] = ' 
    ...
    {   
        ...
        foreach($query->result() as $r) {  
            ...
            if($r->editable == '1'){
                ...
                {
                    $edit = '    <li><a href="#" onclick="edit(this)" data-id="'.$r->id.'">Ubah</a></li>';
                }   
