...
class dashboard_model extends CI_Model
{
   ...
   {
      $this->db->select("a.id, a.kode_item, a.tgl_expired, b.nama_item, MIN(a.jumlah_masuk) as jumlah_masuk");
      $this->db->from("kartu_stok a");
      $this->db->join('master_item b', 'a.kode_item = b.kode_item');
      $this->db->where("a.tgl_expired <= DATE_ADD(CURRENT_DATE, INTERVAL 60 DAY)");
      $this->db->where("a.jumlah_masuk >", 0);
      $this->db->group_by("a.tgl_expired");
