...
class Pembelian_model extends CI_Model{  
    ...
    function getallpo(){   
        ...
        $tomboledit = level_user('pembelian','po',$this->session->userdata('kategori'),'edit') > 0 ? '<li><a href="#" onclick="edit(this)" data-id="$2">Ubah</a></li>':'';
    ...
    function getallpembelian(){   
        ...
        $tomboledit = level_user('pembelian','langsung',$this->session->userdata('kategori'),'edit') > 0 ? '<li><a href="#" onclick="edit(this)" data-id="$2">Ubah</a></li>':'';
