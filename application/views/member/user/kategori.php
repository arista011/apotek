					...
					<header class="panel-heading">
						<div class="row show-grid">
							<div class="col-md-6" align="left">
								<h2 class="panel-title">Data Kategori Pengguna</h2>
							</div>
							<?php
		...
		<div class="modal-dialog  modal-lg" style="width:90%">
			<div class="modal-content">
				<section class="panel panel-primary">
					...
					<header class="panel-heading">
						<h2 class="panel-title">Tambah Kategori Pengguna</h2>
					</header>
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-3">
								<div class="form-group kategori_user">
									Kategori Pengguna <br />
									<input type="text" name="kategori_user" placeholder="Kategori Pengguna" class="form-control" required />
								</div>
							</div>
							<div class="col-sm-6">
		...
		<div class="modal-dialog  modal-lg" style="width:90%">
			<div class="modal-content">
				<section class="panel panel-primary">
					...
					<header class="panel-heading">
						<h2 class="panel-title">Edit Kategori Pengguna</h2>
					</header>
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-3">
								<div class="form-group kategori_useredit">
									Kategori Pengguna <br />
									<input type="text" name="kategori_useredit" id="kategori_useredit" placeholder="Kategori Pengguna" class="form-control" required />
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group kategori">
