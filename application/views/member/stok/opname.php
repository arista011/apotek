                ...
                <section class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group kuantiti_berubah">
                            <label class="col-sm-3 control-label">Stok Berubah <span class="required">*</span></label>
                            <div class="col-sm-9">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(i, item) {
                        ...
                        datarow += "<tr><td>Stok Berubah</td><td>: " + item.kuantiti_berubah + " " + item.satuan_kecil + "</td></tr>";
                        datarow += "<tr><td>Tanggal Kadaluarsa</td><td>: " + item.tgl_expired + "</td></tr>";
