                                    ...
                                    <div class="inner-menu-content">
                                        ...
                                        <div class="sidebar-widget m-none">
                                            <div class="widget-content">
                                                <ul class="mg-folders">
                                                    <li>
                                                        <a href="<?php echo base_url() ?>pembelian/po" class="menu-item"><i class="fa fa-folder"></i> Pemesanan Barang</a>
                                                    ...
                                                    <li>
                                                        <a href="<?php echo base_url() ?>pembelian/langsung" class="menu-item"><i class="fa fa-folder"></i> Pembayaran / Faktur</a>
                                                        <div class="item-options">
                                                ...
                                                <div class="panel-body">
                                                    <div class="widget-summary">
                                                        ...
                                                        <div class="widget-summary-col">
                                                            <div class="summary">
                                                                <h4 class="title">Jumlah Pemesanan Barang</h4>
                                                                <div class="info">
                                            ...
                                            <section class="panel panel-featured-left panel-featured-secondary">
                                                <div class="panel-body">
                                                    <div class="widget-summary">
                                                        ...
                                                        <div class="widget-summary-col">
                                                            <div class="summary">
                                                                <h4 class="title">Jumlah Pembayaran</h4>
                                                                <div class="info">
