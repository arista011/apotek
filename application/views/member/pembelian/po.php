                                            ...
                                            <div class="panel-body bg-primary">
                                                <div class="widget-summary">
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            <h4 class="title">Jumlah Pemesanan Barang Hari Ini</h4>
                                                            <div class="info">
                                        ...
                                        <section class="panel">
                                            <div class="panel-body bg-primary">
                                                <div class="widget-summary">
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            <h4 class="title">Jumlah Pemesanan Barang Minggu Ini</h4>
                                                            <div class="info">
                                        ...
                                        <section class="panel">
                                            <div class="panel-body bg-primary">
                                                <div class="widget-summary">
                                                    <div class="widget-summary-col">
                                                        <div class="summary">
                                                            <h4 class="title">Jumlah Pemesanan Barang Bulan Ini</h4>
                                                            <div class="info">
