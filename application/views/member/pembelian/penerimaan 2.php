            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.datasub, function(i, itemsub) {
                        ...
                        datarow += "<td><input type='text' name='tgl_expired[]' value='" + itemsub.tgl_expired + "' class='form-control tgl_expired' required></td>";
                        datarow += "<td>" + itemsub.satuan_kecil + "</td>";
                        datarow += "<td><input type='number' name='kuantiti[]' value='" + itemsub.kuantiti + "' class='form-control' required></td>";
                        ...
                        datarow += "<td><a href='javascript:void(0);' class='mb-xs mt-xs mr-xs btn btn-danger deleterow'><i class='fa fa-trash-o'></i></a></td>";
                        datarow += "</tr>";
                    });
                    ...
                    $(wrapperItem).on("click", ".deleterow", function(e) {
                        ...
                        document.getElementById(".listitem").removeAttribute('disabled');
                    })
                }
            });
            return false;
