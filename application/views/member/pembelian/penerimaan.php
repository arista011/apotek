            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.datasub, function(i, itemsub) {
                        ...
                        datarow += "<td><input type='text' name='tgl_expired[]' value='" + itemsub.tgl_expired_ymd + "' class='form-control tgl_expired' required></td>";
                    ...
                    $('.listitemditerima').on("click", ".deleterow", function(e) {
                        e.preventDefault();
