                    ...
                    <header class="panel-heading">
                        <div class="row show-grid">
                            <div class="col-md-6" align="left">
                                <h2 class="panel-title">Data Pembayaran / Faktur</h2>
                            </div>
                            <?php
        ...
        <div class="modal-dialog modal-lg" style="width:90%">
            <div class="modal-content">
                <section class="panel panel-primary">
                    ...
                    <header class="panel-heading">
                        <h2 class="panel-title">Tambah Pembayaran / Faktur</h2>
                    </header>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mt-lg kategori">
                                    ...
                                    <div class="col-sm-9">
                                        <select data-plugin-selectTwo class="form-control" name="kategori" id="kategoritambah" required>
                                            ...
                                            <option value="Purchase Order">Pemesanan</option>
        ...
        <div class="modal-dialog modal-lg" style="width:90%">
            <div class="modal-content">
                <section class="panel panel-primary">
                    ...
                    <header class="panel-heading">
                        <h2 class="panel-title">Edit Pembayaran / Faktur</h2>
                    </header>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
