                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-primary modal-confirm" type="submit" id="submitformPembayaran">Simpan</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Batal</span></button>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger" id="submitformHapusPembayaran">Hapus</button>
