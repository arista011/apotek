                                    ...
                                    <div class="inner-menu-content">
                                        <div class="sidebar-widget m-none">
                                            <div class="widget-content">
                                                <ul class="mg-folders">
                                                    <li>
                                                        <a href="<?php echo base_url() ?>laporan/po" class="menu-item"><i class="fa fa-folder"></i> Laporan Pemesanan</a>
                                                    ...
                                                    <li>
                                                        <a href="<?php echo base_url() ?>laporan/pembelian" class="menu-item"><i class="fa fa-folder"></i> Laporan Pembayaran</a>
                                                        <div class="item-options">
